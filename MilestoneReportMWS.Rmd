...
grep("started with",dat10NoStop,value = TRUE)
print(dat10NoPunc)
class(twit10)
twit10Uniq<-unique(twit10)
twitUniq<-unique(twit)
print(dat10NoStop)
...
## It appears to have worked great.
...
uniList <- unigram_tokenizer(dat10Lower)
...
biList <- bigram_tokenizer(dat10Lower)
...
triList <- trigram_tokenizer(dat10Lower)
...
p <- plot_ly(x = dfUni$Word, type = "histogram")
